...
public class Fragment_barcode_bus extends Fragment {
    ...
    public Fragment_barcode_bus(){

    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_barcode_bus, container ,false);
        context = getActivity();
                    ...
                    alertdialog
                            ...
                            .setNegativeButton("확인",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                        IntentIntegrator.forFragment(Fragment_barcode_bus.this).setCaptureActivity(CustomScannerActivity.class).initiateScan();
                                        }
                                    });
...
//            final Call<List<UnitList>> call = erp.getUnisList();
    ...
    public void fragment_reroad(){
        Fragment_barcode_bus fa = new Fragment_barcode_bus();
