...
public class Fragment_c extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        scan_office = (TextView)view.findViewById(R.id.scan_office);
        local_office = (TextView)view.findViewById(R.id.local_office);
...
//                new office_name_info().execute("01200101");
                IntentIntegrator.forFragment(Fragment_c.this).setCaptureActivity(CustomScannerActivity.class).initiateScan();
            }
        });
...
//                make_unit_info("012029001437");
        ...
        submit_barcode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(scan_office.getText().toString().length() == 0){
                    ...
                    EditText reserve_notice = (EditText)getView().findViewById(R.id.reserve_notice);
    ...
    void make_unit_info(String unit_barcode) {
        ...
        TextView reserve_area_name = (TextView)getView().findViewById(R.id.reserve_area_name);
        TextView reserve_unit_barcode = (TextView)getView().findViewById(R.id.reserve_unit_barcode);
        TextView reserve_unit_name = (TextView)getView().findViewById(R.id.reserve_unit_name);
            ...
            call.enqueue(new Callback<List<Bus_infoVo>>() {
                ...
                public void onResponse(Call<List<Bus_infoVo>> call, Response<List<Bus_infoVo>> response) {
                    ...
                    if( list != null){
                        ...
                        actv = (AutoCompleteTextView)getView().findViewById(R.id.bus_num_serch);
        ...
        protected Long doInBackground(String... strings) {
            ...
            call.enqueue(new Callback<List<Trouble_CodeVo>>() {
                ...
                public void onResponse(Call<List<Trouble_CodeVo>> call, Response<List<Trouble_CodeVo>> response) {
                    ...
                    Spinner high_code = (Spinner)getView().findViewById(R.id.trouble_high_spinner);
        ...
        protected Long doInBackground(String... strings) {
            ...
            call.enqueue(new Callback<List<Trouble_CodeVo>>() {
                ...
                public void onResponse(Call<List<Trouble_CodeVo>> call, Response<List<Trouble_CodeVo>> response) {
                    ...
                    Spinner low_code = (Spinner)getView().findViewById(R.id.trouble_low_spinner);
