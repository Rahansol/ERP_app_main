...
//                new office_name_info().execute("01200101");
                IntentIntegrator.forFragment(Fragment_b.this).setCaptureActivity(CustomScannerActivity.class).initiateScan();
            }
        });
...
//                list.add("012029001437");
//                list.add("012022000594");
//                list.add("012010003172");
//                list.add("012006008238");
//                list.add("012005003305");
//                int ra = (int)(Math.random()*5 +1);
//                make_unit_info(list.get(ra));
                IntentIntegrator.forFragment(Fragment_b.this).setCaptureActivity(CustomScannerActivity.class).initiateScan();
            }
        });
