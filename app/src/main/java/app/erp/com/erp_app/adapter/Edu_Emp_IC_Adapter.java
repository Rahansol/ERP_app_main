...
public class Edu_Emp_IC_Adapter extends BaseAdapter {

    private ArrayList<Edu_Emp_Vo> listViewItem = new ArrayList<Edu_Emp_Vo>();

    public Edu_Emp_IC_Adapter() {
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.emp_list_ic_item,parent,false);
        }

        TextView testText = (TextView)convertView.findViewById(R.id.emp_ic);
